...
EXPORT_SYMBOL(priv_driver_txs_test);
EXPORT_SYMBOL(priv_driver_set_tx_test_ac);
EXPORT_SYMBOL(send_add_txs_queue);
EXPORT_SYMBOL(priv_driver_set_tx_test);
EXPORT_SYMBOL(priv_driver_cso_test);
EXPORT_SYMBOL(receive_del_txs_queue);
EXPORT_SYMBOL(priv_driver_rxv_test);
EXPORT_SYMBOL(priv_driver_skip_legal_ch_check);
EXPORT_SYMBOL(priv_driver_rxv_test_result);
EXPORT_SYMBOL(priv_driver_txs_test_result);
EXPORT_SYMBOL(is_frame_test);
EXPORT_SYMBOL(connac2x_rxv_correct_test);
